-- SECTION: lspkeys
-- LSP keymaps that are available globally (not buffer-local)
return {
	{
		"lspkeys",
		for_cat = "lsp",
		...
		after = function()
			...
			utils.map_all("n", {
				...
				{ "<leader>lgn", vim.diagnostic.goto_next, "Go to next diagnostic" },
				{ "<leader>lgp", vim.diagnostic.goto_prev, "Go to previous diagnostic" },
